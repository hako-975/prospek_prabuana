                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <?php if (isset($_GET['btnFilter'])): ?>
                                    <a href="export_excel.php?dari_tanggal=<?= $_GET['dari_tanggal']; ?>&sampai_tanggal=<?= $_GET['sampai_tanggal']; ?>" target="_blank" class="btn btn-sm btn-primary mb-4"><i class="fas fa-file-excel fa-sm text-white-50"></i> Export ke Excel</a>
